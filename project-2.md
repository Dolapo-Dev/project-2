...
![reload nginx](./images/nginx%20reload.PNG)
...
Copy this content into our todo_list.php script:
...
![New Php landing page](./images/php%20landing%20page.PNG)

That means our PHP environment is ready to connect and interact with your MySQL server.
